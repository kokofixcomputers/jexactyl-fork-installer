...
export GITHUB_BASE_URL="https://raw.githubusercontent.com/kokofixcomputers/jexactyl-fork-installer"
...
curl -sSL -o /tmp/lib.sh "$GITHUB_BASE_URL"/refs/heads/master/lib/lib.sh
